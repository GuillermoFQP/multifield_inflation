...
character(len=*), parameter :: field_space_geometry = "Renaux-Petel"                ! Choose between "Euclidean", "Renaux-Petel" or "alpha-attractor"
character(len=*), parameter :: potential_shape = "non-linear"                       ! Choose between "elliptic", "non-linear" or "hybrid"
